...
<div id="header">
	...
	<form name="frm" action="rupdatePro.do" method="post"
		...
		<table id ="reviewwritetable">
			<tr>
				...
				<td width="80%"><input type="text" name="user_id" id="writeinput1"
					value="${dto.user_id}" readonly="readonly" /></td>
			</tr>

			<tr>
				 <td width="20%" align="center">Subject.</td>
				<td width="80%"><input type="text" name="review_title" id="writeinput2"
					value="${dto.review_title}" /></td>
			</tr>

			<tr>
		 		<td width="20%" align="center">Thumbnail.</td>
		 		<td width="80%"><img id="beforeview" src="http://localhost:8090/semiproject/temp/'${dto.review_upload}'" style="width: 100%; height: 300px; object-fit: fit;"/></td>
		    </tr>
			<tr>
				<td width="20%" align="center">Date.</td>
				<td width="80%"><input type="text" name="review_date" style="width: 100%; border: none;"
					value="${dto.review_date}" readonly="readonly"/></td>
			</tr>
			</table>
			...
			<tr>
				...
				<td>
				<textarea name="review_content" id="writetextarea" rows="13" cols="40" style="width: 1200px; resize: none;"><c:out value="${fn:replace(dto.review_content,'<br/>',cn)}" /></textarea>
				</td>
			</tr>
			</table>
				<table>
			<tr>
				...
				<td width="80%"><input type="file" name="review_upload" id="imgfile" /><span>${dto.review_upload}</span>
				</td>
			</tr>

			<tr>
				<div id="rev_reg">
					<input type="image" value="수정" src="../images/qna_register.png" width=75px height=42px;/>&nbsp;&nbsp;
				</div>
