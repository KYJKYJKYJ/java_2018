...
public class ReviewboardPageDTO {
   ...
   public ReviewboardPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
       this(currentPage, totalCount);
       this.searchKey=searchKey;
       this.searchWord=searchWord;
   }

   public ReviewboardPageDTO(int currentPage, int totalCount) {
