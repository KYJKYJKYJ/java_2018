...
public class Java233_ChatClient implements Runnable, ActionListener {
		String host;
		int port;
		String userName;
		private JFrame frm;
		...
		public Java233_ChatClient(String host, int port) {
			this.port = port;
			this.host = host;
	...
	public static void main(String[] args) {
		Java233_ChatClient client = new Java233_ChatClient("192.168.10.120", 7777); // 조장 컴퓨터 아이피 주소 // 로컬호스트 127.0.0.1
		client.initStart();
